...
func (b *baseSection) addHandler(method string, h func(writer http.ResponseWriter, request *http.Request)) {
	...
	if coll.LookupInSlice([]string{http.MethodGet, http.MethodConnect, http.MethodHead, http.MethodPut,
		http.MethodPatch, http.MethodPost, http.MethodDelete, http.MethodOptions, http.MethodTrace}, method) < -1 {
